...
//	@GetMapping
//	public ResponseEntity<List<Long>> getRoomId()
//	{	
//		return new ResponseEntity<List<Long>>(service.getAllId(),HttpStatus.OK);
//	}
//	@GetMapping
//	public List<BookRoomEntity>getBookRoom()
//	{
//		return service.getAllBookRoom();
//	}
	@GetMapping
