...
//	public ResponseEntity<List<RoomEntity>> getAllRoomByiId() 
//	{
//		return  new ResponseEntity<List<RoomEntity>>(roomService.getAllRoomByiId(),HttpStatus.OK);
//	}
	
//	@GetMapping("/roomType/{roomType}")
//	public ResponseEntity<Long[]> getAllRoomId()
//	{	
//		
//		return new ResponseEntity<Long[]>(roomService.getAllRoomId(),HttpStatus.OK);
//		//return null;
//	}
