...
import com.example.demo.exception.ResourceNotFoungException;
...
public class RoomServiceImpl implements RoomService 
{
	...
	{	
		roomRepository.findById(roomId).orElseThrow(()->new ResourceNotFoungException("ProductSerialNo",roomId));
		return roomRepository.save(room);
	}
